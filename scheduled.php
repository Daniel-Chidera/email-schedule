...
/**
 * Schedule Email Page
 * Allows users to schedule new emails
 */
...
$recipient_email = $subject = $message = $scheduled_time = '';
$errors = [];
$success_message = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            $errors[] = 'Failed to schedule email. Please try again.';
        }
...
<head>
    ...
    <title>Schedule Email - EmailScheduler</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 class="page-title">Schedule New Email</h1>
            <p class="page-description">Set up your email to be sent at the perfect time</p>
        </div>
